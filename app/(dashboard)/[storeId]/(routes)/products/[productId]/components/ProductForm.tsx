          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <FormField control={form.control} name="categoryId" render={({ field }) => (
                <FormItem>
                  ...
                  <Select value={field.value} onValueChange={field.onChange} disabled={loading} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="flex flex-col space-y-1 leading-none">
                    ...
                    <FormLabel className="font-normal text-[#64748B]">This product will appear on the home page</FormLabel>
                  </div>
                </FormItem>
              )}
            />
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="flex flex-col space-y-1 leading-none">
                    ...
                    <FormLabel className="font-normal text-[#64748B]">This product will not appear anywhere in the store</FormLabel>
                  </div>
                </FormItem>
              )}
            />
